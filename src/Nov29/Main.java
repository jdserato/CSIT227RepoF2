...
public class Main {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src/sectionf2.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("sectionf3.txt", false))) {
    ...
    static void getLine(FileReader fr) throws IOException {
